              ...
              <div className="help-text">
                <em>
                  <Typography variant="body1" align="center" color="textSecondary">
                    First time bonding <b>{bond.displayName}</b>? <br /> Please approve CanaryX DAO to use your{" "}
      ...
      <Slide direction="left" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
        <Box className="bond-data">
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isSoldOut ? (
                ...
                <>{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4) || "0"} CNYD`}</>
              )}
            </Typography>
          </div>
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4) || "0"} CNYD`}
            </Typography>
          </div>
          ...
          <div className="data-row">
            ...
            <Typography>
              {isSoldOut ? (
                ...
                <>{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondDiscount, 4) || "0"} CNYD`}</>
              )}
            </Typography>
          </div>
