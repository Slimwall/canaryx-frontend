...
function Stake() {
  ...
  const onChangeStake = async (action, isOld) => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(ohmBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your CNYD balance."));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(unstakedVal, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sCNYD balance."));
    }
    await dispatch(
      changeStake({
        address,
                ...
                <div className="card-header">
                  ...
                  {address && oldSohmBalance > 0.01 && (
                    ...
                    >
                      ...
                      <Typography>Migrate sCNYD!</Typography>
                    </Link>
                  )}
                </div>
              </Grid>
                  ...
                  <Grid container spacing={2} alignItems="flex-end">
                    ...
                    <Grid item xs={12} sm={4} md={4} lg={4}>
                      <div className="stake-index">
                        ...
                        <Typography variant="h4">
                          {currentIndex ? <>{trim(currentIndex, 1)} CNYD</> : <Skeleton width="150px" />}
                        </Typography>
                      </div>
                    </Grid>
                  </Grid>
              ...
              <div className="staking-area">
                {!address ? (
                  <div className="stake-wallet-notification">
                    ...
                    <Typography variant="h6">Connect your wallet to stake CNYD</Typography>
                  </div>
                ) : (
                  <>
                      ...
                      <Box className="stake-action-row " display="flex" alignItems="center">
                          ...
                          (!hasAllowance("ohm") && view === 0) || (!hasAllowance("sohm") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>CNYD</b>?
                                    <br />
                                    Please approve CanaryX DAO to use your <b>CNYD</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sCNYD</b>?
                                    <br />
                                    Please approve CanaryX DAO to use your <b>sCNYD</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                        ...
                        <TabPanel value={view} index={0} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "staking", "Stake CNYD")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                        ...
                        <TabPanel value={view} index={1} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "unstaking", "Unstake CNYD")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} CNYD</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sCNYD</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sCNYD</>}
                        </Typography>
                      </div>
