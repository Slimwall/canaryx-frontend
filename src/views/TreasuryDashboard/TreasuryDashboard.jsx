            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric wsoprice">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "wsCNYD = sCNYD * index\n\nThe price of wsCNYD is equal to the price of CNYD multiplied by the current index"
                    }
                  />
                </Typography>
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sCNYD accumulated since the beginning of staking. Basically, how much sCNYD one would have if they staked and held a single CNYD from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sCNYD" : <Skeleton type="text" />}
                </Typography>
              </Box>
              {/* <Box className="metric runway">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "Runway, is the number of days sCNYD emissions can be sustained at a given rate. Lower APY = longer runway"
                    }
                  />
                </Typography>
                <Typography variant="h5">
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                <Chart
                  ...
                  headerText="Protocol Owned Liquidity CNYD-DAI"
