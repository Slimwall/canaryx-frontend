...
import { ReactComponent as MTNBNBImg } from "src/assets/tokens/CNYD-CAND.svg";
import { ReactComponent as CnydCandImg } from "src/assets/tokens/CNYD-CAND.svg";
...
export const dai = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0xA4A0f97292eF3e1D83DF490D7cee802aF9C6ABFf",    // Dai Bond Depository address
      reserveAddress: "0x70Ad7172EF0b131A1428D0c1F66457EB041f2176", // Dai address
    },
    [NetworkID.Testnet]: {
...
export const busd = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0xAaba3b58f0e1912F0c0E355500d3dceFD5ad5Be0",
...
export const ohm_dai = new LPBond({
  name: "MTN_dai_lp",
  displayName: "CAND-CNYD LP",
  bondToken: "DAI",
  bondIconSvg: CnydCandImg,
...
export const allBonds = [dai, ohm_dai ];//mtn_wbnb, cake
